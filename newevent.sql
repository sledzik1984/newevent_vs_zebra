...
--
-- Host: localhost    Database: newevent
-- ------------------------------------------------------
...
CREATE TABLE `sprzet` (
  ...
  `ilosc` varchar(200) NOT NULL,
  `nr` varchar(254) NOT NULL,
  `barcode` varchar(30) NOT NULL,
  `magazyn` varchar(200) NOT NULL,
  `miejsce` varchar(200) NOT NULL,
  `szerokosc` varchar(30) NOT NULL,
  `wysokosc` varchar(30) NOT NULL,
  `glebokosc` varchar(30) NOT NULL,
  `objetosc` varchar(30) NOT NULL,
  `waga` varchar(50) NOT NULL,
  `moc` varchar(50) NOT NULL,
  `kategoria` varchar(100) NOT NULL,
  `nrseryjny` varchar(50) NOT NULL,
...
-- Dump completed on 2024-06-01 14:44:12
